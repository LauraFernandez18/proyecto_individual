...
foreach ($listaMesas as $mesa) {
        ...
        echo "<td><a type='button' class='btn btn-dark' href='../view/crear.reserva.form.php?id={$mesa['id_mesa']}&nsillas={$mesa['num_silla_dispo']}'>Generar reserva</a></td>";
        echo "</tr>";
        ?>
        <?php
        echo "<td><a type='button' class='btn btn-dark'  href='modificar.mesa.form.php?id_mesa={$mesa['id_mesa']}&nombre_mesa={$mesa['nombre_mesa']}&num_silla_dispo={$mesa['num_silla_dispo']}&reservada={$mesa['reservada']}&id_ubi={$mesa['id_ubi']}&tipo_ubi={$mesa['tipo_ubi']}'>Modificar</a></td>";
        echo "</tr>";
        echo "</table>";
}
